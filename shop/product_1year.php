                ...
                <div id="apDiv68" style="border-top:1px solid #d27f19;border-bottom:4px solid #f7941d">
                    <center>
                        <div id="apdiv3menubar" style="background:#f3f3f3;">
                            ...
                            <a href="https://www.engtest.net/shop/product_intelligence.php">
                                <img
                            ...
                            <a href="#">
                                <img src="https://www.engtest.net/img/shop/tab-menu-product/over-1year-package.jpg"></a>
                ...
                <div style="padding:0px 150px;border:0px solid blue;" class="CmPrasanmit">
                    <center>
                        <div id="apDiv69" class="CmPrasanmit" style="padding-top:20px;">
                            <h2><strong>EOL 1 YEAR PACKAGE</strong><br>
                                <span style="font-size:20px;color:#707070;" class="kanit">เรียนตามหลักสูตรต่อเหนื่อง 52
                                    สัปดาห์</span>
                            </h2>
...
for ($i = 0; $i < $rows; $i++) {
    ...
    $path_img = "https://www.engtest.net/img/shop/products/" . $temp_image[$i];
?>
                            ...
                            <div class="col-xs-7" style="border:0px solid blue;">
                                <table class="item_table" border="0" style="width:100%;">
                                    <tr>
                                        ...
                                        <td style="width:100% !important;"><?= $temp_name[$i]; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= number_format($temp_cost[$i], 0); ?> Baht</td>
                                    </tr>
                                    <tr>
...
?>
                    ...
                    <BR>
                    <a href="http://localhost/engtest/eol_system/oneyear.php" style="text-decoration: none;">
