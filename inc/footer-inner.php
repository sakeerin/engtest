    ...
    <div class="container" style="width:1150px">
        <div class="row">
            <div class="col-xs-6 text-white prompt">
                Copyright © 2020 By English Online Co.,Ltd. All rights reserved.
            </div>
            <div class="col-xs-6 text-white text-right prompt">
                ...
                <a href="https://www.engtest.net/mainoffice.php?section=office&&status=login_form"
                    ...
                    Columnists</a> |
                <a href="https://www.engtest.net/contact/contact.php" class="over_a text-white admin-manage"><i
        ...
        <div class="row row-eq-height ">
            <div class="col-xs-3" style="border:0px solid blue;">
                ...
                <div style="border:0px solid #FFF;padding:5px;background:#F9B562;">
                    ...
                    <!-- <a href="https://www.trustmarkthai.com/callbackData/popup.php?data=3d622af-34-5-99de6e6eb06f805f0175925476c33011d9c8f0"
                        class="over_a" target="_blank">
                        <img src="https://www.engtest.net/image/frontend/DBD-Verified-Sliver.jpg"
                ...
                <div class="row row-eq-height">
                    ...
                    <div class="col-xs-3">
                        ...
                        <!-- <script type="text/javascript" language="javascript1.1"
                            src="https://tracker.stats.in.th/tracker.php?uid=2679"></script> -->
                        <script>
