...
<body>
        ...
        <form action="<?php $_PHP_SELF ?>" method="get" name="form1" class="pure-form pure-form-stacked">
            <table width="361" border="0">
                ...
                <tr>
                    <td>Name Title</td>
                    <td>:</td>
                    <td colspan="2"><select name="first">
                ...
                <tr>
                    ...
                    <td colspan="2"><input name="fname" type="text" maxlength="50"
                            ...
                            placeholder="enter your firstname..." required /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="177"><input type="button" name="Reset" value="Reset"
                            ...
                            onclick="window.location='http://localhost/engtest/EOL/get_certificate_gepot_eng.php';" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
	...
	function result($first,$fname,$lname,$file) 
	{
		...
		$pdf->AddPage();
		$pdf->SetXY(0,0); 
		$pdf->Image('../EOL/GEPOT/GEPOT15/Certificate GEPOT15 Eng.jpg','0','0','-150','-150');
