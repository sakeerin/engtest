...
function paging_pagenum($current_page, $total_pages, $page_range, $query_string,$type_id) {
	...
	$result = "";
	 ...
	 if($current_page > 1) {
 		$page = $current_page - 1;
		$result .= "&nbsp;";
 		$result .= "<a href='?type_id=$type_id&&page=$page' style='color:#333;font-weight:bold;'>Previous</a>";
	}
	if($page_start > 1) {
		$page = $page_start - 1;
		$result .= "&nbsp;";
		$result .= "<a href=\"?type_id=$type_id&page=$page\" style='font-color:#9F3ED5;font-weight:bold;'>......</a>";
	}
	...
	for($i = $page_start; $i <= $page_end; $i++) {
		...
		if($i == $current_page) {
			...
			$result .= "<a href='?type_id=$type_id&&page=$i' style='color:#9F3ED5;font-weight:bold;'> $i</a>";
		}
		$result .= "&nbsp;";
	}
	...
	if($current_page < $total_pages) {
 		$page = $current_page + 1;
		$result .= "&nbsp;";
 		$result .= "<a href='?type_id=$type_id&&page=$page' style='color:#333; font-weight:bold;'>Next</a>";
	}
